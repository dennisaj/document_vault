...
class PermissionTests extends GrailsUnitTestCase {
	...
	void testPermissionConstants() {
		assertEquals "org.apache.shiro.authz.permission.AllPermission", Permission.adminPerm
		assertEquals "org.apache.shiro.authz.permission.WildcardPermission", Permission.defaultPerm
	}
