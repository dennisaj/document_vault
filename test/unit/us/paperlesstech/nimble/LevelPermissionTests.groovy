...
class LevelPermissionTests extends GrailsUnitTestCase {
    ...
    void testInvalidPopulationFirstSector() {
        ...
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.first.sector'
        }
    }
    ...
    void testInvalidPopulationSecondSector() {
        ...
        assertTrue levelPermission.errors.errorCount == 1
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.second.sector'
        }
    }
    ...
    void testInvalidPopulationThirdSector() {
        ...
        assertTrue levelPermission.errors.errorCount == 1
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.third.sector'
        }
    }
    ...
    void testInvalidPopulationFourthSector() {
        ...
        assertTrue levelPermission.errors.errorCount == 1
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.fourth.sector'
        }
    }
    ...
    void testInvalidPopulationFifthSector() {
        ...
        assertTrue levelPermission.errors.errorCount == 1
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.fifth.sector'
        }
    }
    ...
    void testInvalidPopulationSixthSector() {
        ...
        assertTrue levelPermission.errors.errorCount == 1
        levelPermission.errors.allErrors.each {
            assertEquals it.code, 'nimble.levelpermission.invalid.sixth.sector'
        }
    }
}
