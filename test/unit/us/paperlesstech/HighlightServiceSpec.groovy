...
class HighlightServiceSpec extends Specification {
	...
	def "test fromJsonMap"() {
		given:
			def party = new Party(id:1)
			def l = [
				"0": JSONObject.NULL,
				"1": [[left:10, top:20, width:30, height:40], JSONObject.NULL, null],
				"2": JSONObject.NULL,
				"3": [JSONObject.NULL, [left:50, top:60, width:70, height:80], null]
			]
		when:
			def out = service.fromJsonMap(party, l)
		then:
			out.size() == 2
