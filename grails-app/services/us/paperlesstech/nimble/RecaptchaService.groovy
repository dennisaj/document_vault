...
class RecaptchaService implements InitializingBean {
	...
	public static String SESSION_KEY = "grails.plugins.nimble.service.recaptcha"
	public static String SESSION_ERROR_KEY = "grails.plugins.nimble.service.recaptcha.error"
