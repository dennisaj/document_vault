...
<body>
	...
	<div id="tabs">
		...
		<g:if test="${user.federated}">
			...
			<li><a href="#tab-delegators" class="icon icon_group_link"><g:message code="nimble.label.delegators" /></a></li>
		</ul>
		...
		<div id="tab-delegators">
			<g:render template="/templates/admin/delegators" contextPath="${pluginContextPath}" model="[parent:user]" />
		</div>
