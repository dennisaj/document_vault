      ...
      <tr>
        ...
        <td>
          <g:if test="${user.external}">
            <input type="radio" name="external" value="true" checked="checked"/><g:message code="nimble.label.true" />
          ...
          <g:else>
            ...
            <input type="radio" name="external" value="false" checked="checked"/><g:message code="nimble.label.false" />
          </g:else>
        </td>
      </tr>
