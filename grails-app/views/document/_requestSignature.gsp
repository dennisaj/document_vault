<div id="request-signature">
	...
	<div id="add-party-container">
		<button id="add-party" title="<g:message code="document-vault.view.signature.addparty" />" onclick="${remoteFunction(action:'addParty', params:[documentId: document.id], onSuccess:'Party.addParty(data)')}">
