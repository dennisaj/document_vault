...
<g:form action="signin" name="signin" class="grid-9">
	...
	<fieldset>
		...
		<input class="left" id="username" type="text" name="username" placeholder="Username" autocapitalize="off" value="${params.username}" tabindex="1" />
		<input class="left" id="password" type="password" name="password" placeholder="Password" tabindex="2" />
