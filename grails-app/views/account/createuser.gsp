...
<p><g:message code="nimble.view.account.registeraccount.initiate.descriptive" /></p>
...
<g:form action="saveuser">
	<table>
		...
		<tr>
			<td valign="top" class="name"><label for="pass"><g:message code="nimble.label.password" /></label></td>
