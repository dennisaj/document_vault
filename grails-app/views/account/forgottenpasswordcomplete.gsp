...
<div class="accountinformation">
	...
	<p><g:message code="nimble.view.account.forgottenpassword.complete.descriptive" /></p>
	<p><g:link controller="auth" action="login" class="button icon icon_user_go"><g:message code="nimble.link.login.basic" /></g:link></p>
</div>
</body>
</html>
