...
// This line was causing IE9 to cry. I would have submitted a bug to the author but googlecode just returns a 400 error when I try...
// TODO Check for updates to this library
// win.HTMLElement && win.HTMLElement.prototype.innerText &&
win.HTMLElement && uuisfunc(win.HTMLElement.prototype.__defineGetter__) &&
(function(proto) {
...
function uucanvascreate(width, height, order, placeHolder) {
	...
	return uu.ie678 ? _buildCanvas(canvas, order || "svg sl fl vml") : canvas;
}
