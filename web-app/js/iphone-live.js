	...
	finishDocument: function(documentId) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				Drawing._alert('Signing complete', '<p><span class="ui-icon ui-icon-circle-check" style="float: left; margin: 0 7px 50px 0;"></span>The document has been successfully signed.</p>');
			},
			type: 'GET',
